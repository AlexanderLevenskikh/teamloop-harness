...
> **Быстрый старт:** [USERGUIDE.ru.md](USERGUIDE.ru.md) · [English User Guide](USERGUIDE.md)
...
## YourAITeam strategy and Codex

- [`adapters/codex/README.md`](adapters/codex/README.md) — Codex adapter setup, model policy, doctor, and live smoke.
- [`docs/research/DEEP_RESEARCH_YOUR_AI_TEAM_STRATEGY_PROMPT.ru.md`](docs/research/DEEP_RESEARCH_YOUR_AI_TEAM_STRATEGY_PROMPT.ru.md) — ready-to-run Deep Research prompt for architecture, economics, role templates, and interface paths.
